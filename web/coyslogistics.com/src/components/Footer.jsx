...
export default function Footer() {
  ...
  const footerLinks = {
    ...
    services: [
      { name: 'Dispatch Academy', href: '/academy' },
      { name: 'Fleet Management', href: '/fleet' },
      { name: 'Driver App', href: '/app' },
    ],
    legal: [
      { name: 'Privacy Policy', href: '/privacy' },
      { name: 'Terms of Service', href: '/terms' },
      { name: 'FMCSA Compliance', href: '/compliance' },
    ],
  }

  return (
    <footer className="bg-trucking-dark text-gray-300">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-4">
              Not just moving freight — moving people forward. Trucking mentorship, dispatching, and fleet solutions.
            </p>
